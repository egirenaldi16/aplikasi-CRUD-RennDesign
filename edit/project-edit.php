          ...
          <div class="col-md-12">
            ...
            <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">Manage Project - Edit</h3>
              </div>
              <!-- /.card-header -->
              <?php
              ...
              if ( isset($_GET["id"]) ){
                  $id = $_GET["id"];
                  $check_no = "SELECT * FROM tb_project WHERE id = '$id'; ";
                  include('../config.php');
              ...
              <form action="project-edit.php" method="post">
                ...
                <input class="form-control" type="number" name="id" maxlength="4" placeholder="<?php echo $row['id']; ?> " readonly/><br>

                <label for="nama_pemesan">Project :</label><br>
                <input class="form-control" type="text" name="project" value="<?php echo $row["project"]; ?>" placeholder="Ex. Egi" /><br>

                <label for="Owner">Owner :</label><br>
                <input class="form-control" type="text" name="owner" value="<?php echo $row["owner"]; ?>" placeholder="Ex. Egi" /><br>
            ...
            if (isset($_POST["simpan"])) {
                ...
                $query = " 
                            UPDATE tb_project SET project = '$project',
                            owner = '$owner'
                            WHERE id = '$id';
                ";
                ...
                if($UPDATE){
                    ...
                    <script>
                    alert('Data gagal,');
                    window.location= 'project-view.php?id=$id';
                    </script>
                    ";
                    }
                }
