          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Manage Project - Tambah</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="project-tambah.php" method="post">
                <div class="card-body">
                <label for="no">Id : <span style="color:red;">*</span></label><br>
                <input class="form-control" type="number" name="id" maxlength="4" placeholder="masukan id" /><br>

                <label for="nama_pemesan">Project :</label><br>
                <input class="form-control" type="text" name="project" placeholder="masukan project" /><br>

                <label for="owner">Owner :</label><br>
                <input class="form-control" type="text" name="owner" placeholder="masukan owner" /><br>
            ...
            if (isset($_POST["simpan"])) {
                ...
                $query = "INSERT INTO tb_project (id, project, owner) VALUES ('$id', '$project','$owner')";
                ...
                if ($insert) {
                    ...
                    echo "
                        <script>
                            ...
                            window.location='../tambah/project-tambah.php';
                        </script>
                    ";
                }
            }
