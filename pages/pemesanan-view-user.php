      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               with font-awesome or any other icon font library -->
          <li class="nav-item">
            <a href="pemesanan-view-user.php" class="nav-link">
    ...
    <div class="row">
          <div class="col-12">
            <div class="card">
                ...
                <a class='btn btn-sm btn-success' href='../tambah/pemesanan-user-tambah.php'><i class="fa fa-plus" style="padding-right: 5px;"></i>Tambah</a>
                <?php
                include('../config.php');
                ...
                while ($row = mysqli_fetch_array($data)) {
                  if (!$hasPrinted) {
                    echo "<a style='height: 30px; width: 140px; float: right;' class='btn btn-sm btn-primary' href='' 
                    onclick='alert(\"Akses Tidak diberikan , Anda bukan admin\");'><i class='fas fa fa-print' style='padding-right: 5px;'></i>Print</a>";
                      ...
                      $tabledata .= "
                            <tr>
                                  ...
                                  <td>
                                        ...
                                        onclick='alert(\"Akses Tidak diberikan , Anda bukan admin\");'>Edit</a>
                                        &nbsp;-&nbsp;
                                        <a class='btn btn-sm btn-danger' href='' 
                                        onclick='alert(\"Akses Tidak diberikan , Anda bukan admin\");'>Hapus</a>
                                  </td>
                            </tr>
                      ";
                      $no++;
