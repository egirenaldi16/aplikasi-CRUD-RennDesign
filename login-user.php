          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary shadow">
              ...
              <form action="login-user.php" method="post">
                <h1 align="center" class="font-weight-bold">LOGIN USER</h1>
                <br>
                ...
                <div class="card-footer">
                  <button type="submit" name="login" class="btn btn-block btn-success btn-sm">Submit</button><br>
                  <p><strong><a href="login.php">Login Sebagai admin?</a></strong></p>
                </div>
              </form>
              <?php
                include("./config.php");
