    ...
    <div class="row">
          <div class="col-12">
            <div class="card">
                ...
                <a class='btn btn-sm btn-success' href='../tambah/manageuser-tambah.php'><i class="fa fa-plus" style="padding-right: 5px;"></i>Tambah</a>
              </div>
              <!-- /.card-header -->
                ...
                while($row = mysqli_fetch_array($data)){
                      $tabledata .= "
                            <tr>
                                  ...
                                  <td>".$row["password"]."</td>
                                  <td>
                                        <a class='btn btn-sm btn-success' href='../edit/manageuser-edit.php?id=".$row["id"]."'>Edit</a>
                                        &nbsp;-&nbsp;
                                        <a class='btn btn-sm btn-danger' href='../hapus/manageuser-hapus.php?id=".$row["id"]."' 
