          ...
          <div class="col-md-12">
            ...
            <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">Manage User- Edit</h3>
              </div>
              <?php
            
              if ( isset($_GET["id"]) ){
                  $id = $_GET["id"];
                  $check_no = "SELECT * FROM userlogin WHERE id = '$id'; ";
                  include('../config.php');
              ...
              ?>
              <!-- form start -->
              <form action="manageuser-edit.php" method="post">
                <div class="card-body">
                <label for="no">Id : <span style="color:red;">*</span></label><br>
                <input class="form-control" type="number" name="no" value="<?php echo $row["id"]; ?>" maxlength="4" placeholder="" readonly /><br>

                <label for="nama_pemesan">Username :</label><br>
                <input class="form-control" type="text" name="username" placeholder="masukan username" /><br>

                <label for="No_telp">Password :</label><br>
                <input class="form-control" type="text" name="password" placeholder="masukan password" /><br>
            ...
            if (isset($_POST["simpan"])) {
                ...
                $query = " 
                            UPDATE userlogin SET username = '$username',
                ...
                if($UPDATE){
                    ...
                    <script>
                    alert('Data gagal,');
                    window.location= 'manageuser-view.php?id=$id';
                    </script>
                    ";
                    }
                }
