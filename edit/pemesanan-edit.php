...
<div class="wrapper">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">Data Pemesanan - Edit</h3>
              </div>
              <!-- /.card-header -->
              <?php
              ...
              ?>
              <!-- form start -->
              <form action="pemesanan-edit.php" method="post">
                <div class="card-body">
                <label for="no">No Pemesanan:</label><br>
                <input class="form-control" type="number" value="<?php echo $row["no"]; ?>" name="no" placeholder="no pemesanan" readonly/><br>

                <label for="nama_pemesan">Nama Pemesan :</label><br>
                <input class="form-control" type="text" value="<?php echo $row["nama_pemesan"]; ?>" name="nama_pemesan" placeholder="Ex. Egi" /><br>

                <label for="No_telp">No Telp :</label><br>
                <input class="form-control" type="text" value="<?php echo $row["no_telp"]; ?>" name="no_telp" placeholder="Ex Jenis kelamin" /><br>
                ...
                if (isset($_GET["no"])) {
                    $no = $_GET["no"];
                    $check_no = "SELECT * FROM tb_project WHERE id = '$no';"; // Use $no instead of $id
                    $query = mysqli_query($mysqli, $check_no);
                    $row = mysqli_fetch_array($query);
                }
                ...
                <select name="jenis" class="form-control select2" style="width: 100%;">
                  ...
                  <select name="status" class="form-control" style="width: 100%;">
                      ...
                      <option value="Sedang Dalam Pengerjaan">Sedang Dalam Pengerjaan</option>
            ...
            if (isset($_POST["simpan"])) {
                ...
                $query = " 
                            UPDATE tb_pemesanan SET nama_pemesan = '$nama_pemesan',
                            no_telp = '$no_telp', 
                            jenis = '$jenis',
                            status = '$status'
                            WHERE no = '$no';
                ...
                if($UPDATE){
                    ...
                    <script>
                    alert('Data gagal,');
                    window.location= 'pemesanan-view.php?no=$no';
                    </script>
                    ";
                    }
                }
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023</strong> Egi Renaldi<strong>Copyright &copy; 202342021</strong> Egi Renaldi
  </footer>
